...
const UNREAD_KEY = 'air_quality_unread_count';
...
const Sidebar = () => {
    ...
    useEffect(() => {
        ...
        socket.on('notification', (notification) => {
            ...
            // Jika user sedang membuka halaman Notifikasi,
            // tidak perlu menambah badge
        ...
        socket.on('connect', () => {
            console.log('✅ Sidebar Socket.IO terhubung');
        });
        ...
        socket.on('disconnect', () => {
            console.log('⚠️ Sidebar Socket.IO terputus');
        });
    ...
    useEffect(() => {
        const handleStorageChange = () => {
            try {
                ...
                setUnreadCount(saved ? Number(saved) : 0);
            } catch (error) {
                console.error(
